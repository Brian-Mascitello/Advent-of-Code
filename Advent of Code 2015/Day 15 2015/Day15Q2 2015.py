...
def obtain_high_score(ingredient_dict):
    ...
    for combo in itertools.combinations_with_replacement(ingredient_dict.keys(), 100):
        ...
        for ingredient in combo:
            ...
            calories += ingredient_dict[ingredient]['calories']

        if calories != 500:
            continue
        elif capacity < 1 or durability < 1 or flavor < 1 or texture < 1:
            continue
...
print(top_score)  # 21367368 or 1766400 with 500 calories exactly
